						...
						>
							{priceToday.platforms.map(
								({
									...
									const fluctuation_bsColor =
										fluctuation_bs > 0
											? colors.positive
											: fluctuation_bs < 0
											? colors.negative
											: colors.neutral;
									const fluctuation_percentColor =
									...
									return (
										...
										>
											...
											<View style={styles.contentCenter}>
												...
												<Text
													style={styles.textCurrentPrice}
												>{`Bs. ${price}`}</Text>
											</View>
											<View style={styles.contentRight}>
												<Text
													style={[
														styles.textFluctuationPrice,
														{ color: fluctuation_bsColor },
													]}
												>
													{fluctuation_bs}
												</Text>
												<Text
													style={[
														styles.textPercentFluctuationPrice,
														{ color: fluctuation_percentColor },
													]}
												>{`${fluctuation_percent}%`}</Text>
											</View>
										</TouchableOpacity>
									);
								}
